import { Avatar, Box, Button, Card, Center, Icon, IconButton, Image, Input, Stack, Text, useColorModeValue } from '@chakra-ui/react';
...
export default function Article() {
  const { handleButtonClick, handleSubmit, handleChange, fileInputRef, postData } = useThreadCard();
